declare module 'ui5Extra/ODataFetch/ODataFetch' {
  ...
  /**
   * @class
   * Constructor for a new <code>ui5Extra.ODataFetch.ODataFetch</code> control.
   *
   * Extends sap.ui.model.odata.v2.ODataModel in order to use Promise and async/await code
   *
   * @extends sap.ui.model.odata.v2.ODataModel
   * @public
   * @namespace ui5Extra.ODataFetch
   */
